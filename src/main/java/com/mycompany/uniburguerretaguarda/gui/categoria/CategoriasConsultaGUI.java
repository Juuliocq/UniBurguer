...
public class CategoriasConsultaGUI extends javax.swing.JFrame {
    
    private List<Categoria> categorias = new ArrayList<>();
    private final CategoriaService categoriaService = new CategoriaService();

    public CategoriasConsultaGUI() {
        initComponents();
 ...
 private void setModel(Object info[][]) {
    ...
    private void visualizar() {
        ...
        CategoriaCadastroGUI form = new CategoriaCadastroGUI();
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        try {
            ...
            Logger.getLogger(CategoriasConsultaGUI.class.getName()).log(Level.SEVERE, null, ex);
        }
